...
Original file is located at
    https://colab.research.google.com/drive/1MPCbF7gcag6KoEP79zMp0NkdkKK0PoOc
...
q5 = """
      ...
      WHERE{
        ...
        ?animal <http://xmlns.com/foaf/0.1/knows> ?animal2 .
        ?animal2 rdf:type <http://somewhere#Animal> .
...
q6 = """
      SELECT ?age ?lt
      WHERE{
        ?lt rdf:type/rdfs:subClassOf* <http://somewhere#LivingThing> .
        ?lt <http://xmlns.com/foaf/0.1/age> ?age.
      }
      ORDER BY DESC(?age)
    """
